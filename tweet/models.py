...
class Tweet(models.Model):
    ...
    retweets = models.IntegerField(default=0, help_text="The number of retweets", verbose_name="Retweets") # Todo: same as likes?
    commented_retweets = models.IntegerField(default=0, help_text="The number of commented retweets", verbose_name="Commented Retweets") # Todo: same as likes?
